...
- [test]  [32m✓[39m src/components/error-boundary.test.tsx [2m([22m[2m9 tests[22m[2m)[22m[33m 376[2mms[22m[39m
- [test] [21:58:16] [33mWARN[39m: [36mNo email adapter provided. Email will be written to console. More info at https://payloadcms.com/docs/email/overview.[39m
- [test]  [31m❯[39m tests/int/api.int.spec.ts [2m([22m[2m1 test[22m[2m | [22m[31m1 failed[39m[2m)[22m[33m 460[2mms[22m[39m
- [test]  [32m✓[39m src/pages/error/ErrorPage.test.tsx [2m([22m[2m6 tests[22m[2m)[22m[33m 406[2mms[22m[39m
- [test]      [33m[2m✓[22m[39m renders generic error heading [33m 333[2mms[22m[39m
- [test]  [32m✓[39m src/pages/error/NotFoundPage.test.tsx [2m([22m[2m3 tests[22m[2m)[22m[32m 277[2mms[22m[39m
- [test]  [32m✓[39m src/utils/error-reporter.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 39[2mms[22m[39m
- [test] [2m Test Files [22m [1m[31m1 failed[39m[22m[2m | [22m[1m[32m124 passed[39m[22m[90m (125)[39m
- [test] [2m      Tests [22m [1m[31m1 failed[39m[22m[2m | [22m[1m[32m1742 passed[39m[22m[90m (1743)[39m
- [test] ::error file=/home/runner/work/Kody-Engine-Tester/Kody-Engine-Tester/tests/int/api.int.spec.ts,title=tests/int/api.int.spec.ts > API > fetches users,line=15,column=19::Error: Failed query: select "users"."id", "users"."first_name", "users"."last_name", "users"."display_name", "users"."avatar_id", "users"."bio", "users"."role", "users"."organization", "users"."refresh_token", "users"."token_expires_at", "users"."last_token_used_at", "users"."last_login", "users"."permissions", "users"."updated_at
...
- [test] The above error occurred in the <ThrowError> component.
- [test] React will try to recreate this component tree from scratch using the error boundary you provided, ErrorBoundary.
- [test] (node:49904) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
...
- [test] [31m[1mError[22m: Failed query: select "users"."id", "users"."first_name", "users"."last_name", "users"."display_name", "users"."avatar_id", "users"."bio", "users"."role", "users"."organization", "users"."refresh_token", "users"."token_expires_at", "users"."last_token_used_at", "users"."last_login", "users"."permissions", "users"."updated_at", "users"."created_at", "users"."email", "users"."reset_password_token", "users"."reset_password_expiration", "users"."salt", "users"."hash", "users"."lo
- [test] [31m[1mCaused by: error[22m: column users.first_name does not exist[39m
- [test] [31m[1mSerialized Error:[22m[39m [90m{ length: 114, severity: 'ERROR', code: '42703', detail: undefined, hint: undefined, position: '22', internalPosition: undefined, internalQuery: undefined, where: undefined, schema: undefined, table: undefined, dataType: undefined, constraint: undefined, file: 'parse_relation.c', routine: 'errorMissingColumn' }[39m
