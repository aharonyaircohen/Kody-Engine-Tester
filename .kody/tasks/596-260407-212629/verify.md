...
- [test]  [31m❯[39m src/utils/format-date.test.ts [2m([22m[2m17 tests[22m[2m | [22m[31m2 failed[39m[2m)[22m[32m 18[2mms[22m[39m
- [test]  [32m✓[39m src/pages/error/NotFoundPage.test.tsx [2m([22m[2m3 tests[22m[2m)[22m[32m 96[2mms[22m[39m
- [test]  [32m✓[39m src/pages/error/ErrorPage.test.tsx [2m([22m[2m6 tests[22m[2m)[22m[32m 96[2mms[22m[39m
- [test]  [32m✓[39m src/components/error-boundary.test.tsx [2m([22m[2m9 tests[22m[2m)[22m[32m 128[2mms[22m[39m
- [test] [21:41:22] [31mERROR[39m: [36mError: cannot connect to Postgres. Details: connect ECONNREFUSED 127.0.0.1:5432[39m
- [test]       "type": "Error",
...
- [test] [2m      Tests [22m [1m[31m2 failed[39m[22m[2m | [22m[1m[32m1769 passed[39m[22m[2m | [22m[33m1 skipped[39m[90m (1772)[39m
...
- [lint]   9:5  warning  'jwtService' is assigned a value but never used. Allowed unused vars must match /^_/u  @typescript-eslint/no-unused-vars
...
- [test] [31m⎯⎯⎯⎯⎯⎯[39m[1m[41m Unhandled Errors [49m[22m[31m⎯⎯⎯⎯⎯⎯[39m
- [test] This might cause false positive tests. Resolve unhandled errors to make sure your tests are not affected.[22m[39m
- [lint] /Users/aguy/projects/Kody-Engine-Tester/tests/int/rbac.int.spec.ts
- [lint] ✖ 154 problems (13 errors, 141 warnings)
...
/Users/aguy/projects/Kody-Engine-Tester/tests/int/rbac.int.spec.ts
  9:5  warning  'jwtService' is assigned a value but never used. Allowed unused vars must match /^_/u  @typescript-eslint/no-unused-vars
