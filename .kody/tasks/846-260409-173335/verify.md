...
- [test]  [31m❯[39m src/utils/format-date.test.ts [2m([22m[2m17 tests[22m[2m | [22m[31m2 failed[39m[2m)[22m[32m 23[2mms[22m[39m
- [test]  [32m✓[39m src/components/error-boundary.test.tsx [2m([22m[2m9 tests[22m[2m)[22m[32m 144[2mms[22m[39m
- [test]  [32m✓[39m src/pages/error/ErrorPage.test.tsx [2m([22m[2m6 tests[22m[2m)[22m[32m 115[2mms[22m[39m
- [test]  [32m✓[39m src/pages/error/NotFoundPage.test.tsx [2m([22m[2m3 tests[22m[2m)[22m[32m 145[2mms[22m[39m
- [test] [17:36:54] [31mERROR[39m: [36mError: cannot connect to Postgres. Details: connect ECONNREFUSED 127.0.0.1:5432[39m
- [test]       "type": "Error",
- [test]           Error: connect ECONNREFUSED 127.0.0.1:5432
- [test]  [32m✓[39m src/utils/error-reporter.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 10[2mms[22m[39m
...
- [playwright] [17:37:17] [31mERROR[39m: [36mError: cannot connect to Postgres. Details: connect ECONNREFUSED 127.0.0.1:5432[39m
- [playwright]       "type": "Error",
- [playwright]           Error: connect ECONNREFUSED 127.0.0.1:5432
- [playwright] [1A[2K[17:37:17] [31mERROR[39m: [36mError: cannot connect to Postgres. Details: connect ECONNREFUSED 127.0.0.1:5432[39m
- [playwright]       "type": "Error",
- [playwright]           Error: connect ECONNREFUSED 127.0.0.1:5432
- [playwright]     Error: Error: cannot connect to Postgres: connect ECONNREFUSED 127.0.0.1:5432
- [playwright]     Error: Error: cannot connect to Postgres: connect ECONNREFUSED 127.0.0.1:5432
- [playwright]     Error: [2mexpect([22m[31mpage[39m[2m).[22mtoHaveTitle[2m([22m[32mexpected[39m[2m)[22m failed
- [playwright]     Error Context: test-results/frontend.e2e-Frontend-can-go-on-homepage-chromium/error-context.md
- [playwright] [1A[2K  2 failed
...
### playwright
```
pm/payload@3.80.0_graphql@16.13.2_typescript@5.7.3/node_modules/payload/src/index.ts:891:7)
...
[1A[2K  2) [chromium] › tests/e2e/frontend.e2e.spec.ts:11:3 › Frontend › can go on homepage ──────────────
    ...
    Expected pattern: [32m/Payload Blank Template/[39m
    Received string:  [31m"A-Guy | תרגול מתמטיקה אינטראקטיבי"[39m
    Timeout: 5000ms

    Call log:
    [2m  - Expect "toHaveTitle" with timeout 5000ms[22m
    [2m    9 × unexpected value "A-Guy | תרגול מתמטיקה אינטראקטיבי"[22m
    ...
    > 14 |     await expect(page).toHaveTitle(/Payload Blank Template/)
         |                        ^
      15 |
      16 |     const heading = page.locator('h1').first()
      17 |
        at /Users/aguy/projects/Kody-Engine-Tester/tests/e2e/frontend.e2e.spec.ts:14:24

    Error Context: test-results/frontend.e2e-Frontend-can-go-on-homepage-chromium/error-context.md
