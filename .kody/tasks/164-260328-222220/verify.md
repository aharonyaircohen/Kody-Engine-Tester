...
- [lint]   74:5   warning  Unused eslint-disable directive (no problems were reported from '@typescript-eslint/no-explicit-any')
- [lint]   81:10  warning  Unexpected any. Specify a different type                                                               @typescript-eslint/no-explicit-any
- [lint]   21:36  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   31:39  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   15:30  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   18:9   warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   25:41  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   28:29  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   30:30  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   33:9   warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   45:39  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   48:31  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   59:36  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   80:36  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
- [lint]   91:10  warning  Unexpected any. Specify a different type  @typescript-eslint/no-explicit-any
