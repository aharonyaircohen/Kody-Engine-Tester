...
- [lint]   70:21  warning  'q2' is assigned a value but never used. Allowed unused elements of array destructuring must match /^_/u  @typescript-eslint/no-unused-vars
...
- [lint] ✖ 94 problems (13 errors, 81 warnings)
...
### lint
```
sed. Allowed unused vars must match /^_/u    @typescript-eslint/no-unused-vars
...
/home/runner/work/Kody-Engine-Tester/Kody-Engine-Tester/src/utils/priority-queue.test.ts
  70:21  warning  'q2' is assigned a value but never used. Allowed unused elements of array destructuring must match /^_/u  @typescript-eslint/no-unused-vars
...
✖ 94 problems (13 errors, 81 warnings)
