...
- [test] [16:13:30] [33mWARN[39m: [36mNo email adapter provided. Email will be written to console. More info at https://payloadcms.com/docs/email/overview.[39m
- [test]  [32m✓[39m src/pages/error/ErrorPage.test.tsx [2m([22m[2m6 tests[22m[2m)[22m[33m 396[2mms[22m[39m
...
- [test] [16:14:35] [33mWARN[39m: [36mNo email adapter provided. Email will be written to console. More info at https://payloadcms.com/docs/email/overview.[39m
- [test] ··×[16:15:06] [33mWARN[39m: [36mNo email adapter provided. Email will be written to console. More info at https://payloadcms.com/docs/email/overview.[39m
- [test] ×[16:15:11] [33mWARN[39m: [36mNo email adapter provided. Email will be written to console. More info at https://payloadcms.com/docs/email/overview.[39m
- [test]     Error: Failed query: select distinct "payload_preferences"."id", "payload_preferences"."created_at", "payload_preferences"."created_at" from "payload_preferences" left join "payload_preferences_rels" "753dc1d5_77cf_495a_955f_b6a9e6f43474" on ("payload_preferences"."id" = "753dc1d5_77cf_495a_955f_b6a9e6f43474"."parent_id" and "753dc1d5_77cf_495a_955f_b6a9e6f43474"."path" like $1) where (("753dc1d5_77cf_495a_955f_b6a9e6f43474"."users_id" in ($2) and "753dc1d5_77cf_495a_955f_b6a9e6f43474"."user
- [test]     [cause]: error: current transaction is aborted, commands ignored until end of transaction block
- [test]     Error Context: test-results/admin.e2e-Admin-Panel-can-navigate-to-edit-view-chromium/error-context.md
- [test]     Error: Failed query: select distinct "payload_preferences"."id", "payload_preferences"."created_at", "payload_preferences"."created_at" from "payload_preferences" left join "payload_preferences_rels" "75ff1e96_f64b_470f_9d33_b7c6425865eb" on ("payload_preferences"."id" = "75ff1e96_f64b_470f_9d33_b7c6425865eb"."parent_id" and "75ff1e96_f64b_470f_9d33_b7c6425865eb"."path" like $1) where (("75ff1e96_f64b_470f_9d33_b7c6425865eb"."users_id" in ($2) and "75ff1e96_f64b_470f_9d33_b7c6425865eb"."user
- [test]     [cause]: error: current transaction is aborted, commands ignored until end of transaction block
- [test]     Error: Failed query: select distinct "payload_preferences"."id", "payload_preferences"."created_at", "payload_preferences"."created_at" from "payload_preferences" left join "payload_preferences_rels" "386ae06c_b7bb_4006_9ca9_3d34f404f435" on ("payload_preferences"."id" = "386ae06c_b7bb_4006_9ca9_3d34f404f435"."parent_id" and "386ae06c_b7bb_4006_9ca9_3d34f404f435"."path" like $1) where (("386ae06c_b7bb_4006_9ca9_3d34f404f435"."users_id" in ($2) and "386ae06c_b7bb_4006_9ca9_3d34f404f435"."user
- [test]     [cause]: error: current transaction is aborted, commands ignored until end of transaction block
- [test]     Error: Failed query: select distinct "payload_preferences"."id", "payload_preferences"."created_at", "payload_preferences"."created_at" from "payload_preferences" left join "payload_preferences_rels" "06ee9456_325b_40a5_8123_fde804973669" on ("payload_preferences"."id" = "06ee9456_325b_40a5_8123_fde804973669"."parent_id" and "06ee9456_325b_40a5_8123_fde804973669"."path" like $1) where (("06ee9456_325b_40a5_8123_fde804973669"."users_id" in ($2) and "06ee9456_325b_40a5_8123_fde804973669"."user
- [test]     [cause]: error: current transaction is aborted, commands ignored until end of transaction block
- [test]     Error: Failed query: select distinct "payload_preferences"."id", "payload_preferences"."created_at", "payload_preferences"."created_at" from "payload_preferences" left join "payload_preferences_rels" "6d7d5f29_7056_4a2e_b657_672a6d50571f" on ("payload_preferences"."id" = "6d7d5f29_7056_4a2e_b657_672a6d50571f"."parent_id" and "6d7d5f29_7056_4a2e_b657_672a6d50571f"."path" like $1) where (("6d7d5f29_7056_4a2e_b657_672a6d50571f"."users_id" in ($2) and "6d7d5f29_7056_4a2e_b657_672a6d50571f"."user
- [test]     [cause]: error: current transaction is aborted, commands ignored until end of transaction block
- [test]   1 failed
...
- [test] The above error occurred in the <ThrowError> component.
- [test] React will try to recreate this component tree from scratch using the error boundary you provided, ErrorBoundary.
- [test] (node:84330) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
- [test] (Use `node --trace-warnings ...` to show where the warning was created)
- [test] [WebServer] (node:85482) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
- [test] [WebServer] (Use `node --trace-warnings ...` to show where the warning was created)
- [test] (node:85526) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
- [test] (Use `node --trace-warnings ...` to show where the warning was created)
- [test] (node:85803) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
- [test] (Use `node --trace-warnings ...` to show where the warning was created)
- [test] (node:85898) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
- [test] (Use `node --trace-warnings ...` to show where the warning was created)
...
[WebServer] (node:85482) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
[WebServer] In the next major version (pg-connection-string v3.0.0 and pg v9.0.0), these modes will adopt standard libpq semantics, which have weaker security guarantees.
[WebServer] 
[WebServer] To prepare for this change:
[WebServer] - If you want the current behavior, explicitly use 'sslmode=verify-full'
[WebServer] - If you want libpq compatibility now, use 'uselibpqcompat=true&sslmode=require'
[WebServer] 
[WebServer] See https://www.postgresql.org/docs/current/libpq-ssl.html for libpq SSL mode definitions.
[WebServer] (Use `node --trace-warnings ...` to show where the warning was created)
(node:85526) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
...
See https://www.postgresql.org/docs/current/libpq-ssl.html for libpq SSL mode definitions.
(Use `node --trace-warnings ...` to show where the warning was created)
(node:85803) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
In the next major version (pg-connection-string v3.0.0 and pg v9.0.0), these modes will adopt standard libpq semantics, which have weaker security guarantees.
...
See https://www.postgresql.org/docs/current/libpq-ssl.html for libpq SSL mode definitions.
(Use `node --trace-warnings ...` to show where the warning was created)
(node:85898) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
In the next major version (pg-connection-string v3.0.0 and pg v9.0.0), these modes will adopt standard libpq semantics, which have weaker security guarantees.
