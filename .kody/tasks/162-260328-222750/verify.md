...
- [lint]     2:31  warning  'SearchFilters' is defined but never used. Allowed unused vars must match /^_/u     @typescript-eslint/no-unused-vars
- [lint]     2:46  warning  'SortOption' is defined but never used. Allowed unused vars must match /^_/u        @typescript-eslint/no-unused-vars
- [lint]     2:58  warning  'SearchPagination' is defined but never used. Allowed unused vars must match /^_/u  @typescript-eslint/no-unused-vars
- [lint]    28:3   warning  'page' is assigned a value but never used. Allowed unused args must match /^_/u     @typescript-eslint/no-unused-vars
- [lint]    37:29  warning  'limit' is defined but never used. Allowed unused args must match /^_/u             @typescript-eslint/no-unused-vars
- [lint]   222:34  warning  'limit' is defined but never used. Allowed unused args must match /^_/u             @typescript-eslint/no-unused-vars
...
- [lint] ✖ 61 problems (7 errors, 54 warnings)
...
### lint
```
ver used. Allowed unused args must match /^_/u     @typescript-eslint/no-unused-vars
   37:29  warning  'limit' is defined but never used. Allowed unused args must match /^_/u             @typescript-eslint/no-unused-vars
  222:34  warning  'limit' is defined but never used. Allowed unused args must match /^_/u             @typescript-eslint/no-unused-vars
...
✖ 61 problems (7 errors, 54 warnings)
