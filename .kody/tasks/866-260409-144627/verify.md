...
- [test] [15:06:03] [33mWARN[39m: [36mNo email adapter provided. Email will be written to console. More info at https://payloadcms.com/docs/email/overview.[39m
- [test]  [31m❯[39m tests/int/api.int.spec.ts [2m([22m[2m1 test[22m[2m | [22m[31m1 failed[39m[2m)[22m[33m 617[2mms[22m[39m
- [test]  [32m✓[39m src/pages/error/ErrorPage.test.tsx [2m([22m[2m6 tests[22m[2m)[22m[33m 447[2mms[22m[39m
- [test]      [33m[2m✓[22m[39m renders generic error heading [33m 362[2mms[22m[39m
- [test]  [32m✓[39m src/components/error-boundary.test.tsx [2m([22m[2m9 tests[22m[2m)[22m[33m 524[2mms[22m[39m
...
- [test] [2m      Tests [22m [1m[31m1 failed[39m[22m[2m | [22m[1m[32m1772 passed[39m[22m[90m (1773)[39m
...
- [test] (node:23058) Warning: SECURITY WARNING: The SSL modes 'prefer', 'require', and 'verify-ca' are treated as aliases for 'verify-full'.
...
tests/helpers/seedUser.ts(26,24): error TS2345: Argument of type '{ collection: "users"; data: { email: string; password: string; }; draft: false; }' is not assignable to parameter of type 'Options<"users", UsersSelect<false> | UsersSelect<true>>'.
  Types of property 'data' are incompatible.
    Type '{ email: string; password: string; }' is not assignable to type 'Omit<User, "id" | "createdAt" | "deletedAt" | "updatedAt" | "collection"> & Partial<Pick<User, "id" | "createdAt" | "deletedAt" | "updatedAt" | "collection">>'.
      Type '{ email: string; password: string; }' is missing the following properties from type 'Omit<User, "id" | "createdAt" | "deletedAt" | "updatedAt" | "collection">': firstName, lastName, role
