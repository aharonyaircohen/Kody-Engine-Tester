...
- [lint]   30:9  error  'node' is never reassigned. Use 'const' instead  prefer-const
...
- [lint] ✖ 94 problems (14 errors, 80 warnings)
...
### lint
```
Tester/src/services/quiz-grader.test.ts
...
/home/runner/work/Kody-Engine-Tester/Kody-Engine-Tester/src/utils/trie.ts
  30:9  error  'node' is never reassigned. Use 'const' instead  prefer-const
...
✖ 94 problems (14 errors, 80 warnings)
