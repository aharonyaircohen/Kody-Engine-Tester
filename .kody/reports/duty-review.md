# Kody Capability Review

_Rolling 6h cycle — one capability deep-reviewed per tick._

Cycle 10 — 5 healthy, 11 broken, 22 pending of 38 capabilities.
...
| ceo-performance-review | ceo | 7d | broken | no state file ever created; procedure says engine writes .kody/capabilities/ceo-performance-review/state.json but it does not exist; no commit history for any state file |
