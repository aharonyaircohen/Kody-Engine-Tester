...
`<!-- kody-capability: {{capability}} -->` line keys trust to THIS capability (not the shared
agent) — always include it. Approve records under this capability's `merge` action;
