...
`<!-- kody-agentResponsibility: {{agentResponsibility}} -->` line keys trust to THIS agentResponsibility (not the shared
agent) — always include it. Approve records under this agentResponsibility's `merge` action;
