...
describe('UserStore', () => {
  ...
  describe('create', () => {
    it('should create a user with hashed password', async () => {
      const user = await store.create({ email: 'new@example.com', password: 'Password1!', role: 'viewer', roles: ['viewer'] })
    ...
    it('should throw on duplicate email', async () => {
      await expect(store.create({ email: 'admin@example.com', password: 'Password1!', role: 'viewer', roles: ['viewer'] }))
