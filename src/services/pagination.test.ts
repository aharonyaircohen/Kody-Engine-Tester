...
describe('paginate', () => {
  ...
  it('should return the last page with potentially fewer items', () => {
    const items = [1, 2, 3, 4, 5, 6]
  ...
  it('should return empty data array when page exceeds pages', () => {
    const items = [1, 2, 3, 4, 5, 6]
  ...
  it('should return all items on a single page when pageSize exceeds items', () => {
    const items = [1, 2, 3]
