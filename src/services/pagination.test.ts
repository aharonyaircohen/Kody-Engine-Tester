...
describe('paginate', () => {
  ...
  it('should return an empty data array for page beyond total pages', () => {
    const items = [1, 2, 3, 4, 5, 6]
  ...
  it('should return all items when page size is larger than total items', () => {
    const items = [1, 2, 3]
  ...
  it('should return an empty data array for empty input', () => {
    const items: number[] = []
    const result = paginate(items, 1, 2)
    expect(result.data).toEqual([])
  ...
  it('should handle remainder elements on the last page', () => {
  ...
  it('should handle page 1 when there are multiple pages', () => {
    const items = ['x', 'y', 'z', 'w']
