...
describe('paginate', () => {
  ...
  it('should return the last page with remainder elements', () => {
  ...
  it('should throw an error for page size <= 0', () => {
  ...
  it('should return first page when page is 1 and pageSize equals total', () => {
    const items = [1, 2, 3]
